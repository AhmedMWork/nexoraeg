...
set search_path = public, pg_catalog
as $$
  select public.nexora_uuid_v5_5_4();
$$;

comment on function public.nexora_uuid_v5_5_4() is 'NEXORA safe UUID generator. Avoids live failures caused by broken/missing pgcrypto gen_random_bytes.';
...
alter table if exists public.admin_action_notes alter column id set default public.nexora_uuid_v5_5_5();
...
declare
  test_uuid uuid;
begin
  select public.nexora_uuid_v5_5_4() into test_uuid;
