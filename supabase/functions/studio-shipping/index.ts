  ...
  try {
    ...
    if (action === 'save-settings') {
      ...
      const allowed: Record<string, unknown> = {
        ...
        fallback_delivery_estimate: String(settings.fallback_delivery_estimate ?? settings.fallbackDeliveryEstimate ?? '4-7 business days'),
    ...
    if (action === 'upsert-zone') {
      ...
      const row: Record<string, unknown> = {
        ...
        delivery_estimate: String(zone.delivery_estimate ?? zone.deliveryEstimate ?? '4-7 business days'),
