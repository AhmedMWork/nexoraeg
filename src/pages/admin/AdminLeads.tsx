...
export default function AdminLeads() {
  ...
  return (
    <div className="space-y-6">
      ...
      {active === 'Follow ups' && <div className="studio-card p-8 text-sm leading-7 text-[#A7AEBB]"><Clock className="mb-3 h-5 w-5 text-[#D7B98E]" />Follow-up tasks are stored in Supabase through the Task button. V5.5 keeps it honest: tasks save only after the Edge Function confirms success.</div>}
    </div>
  );
}
